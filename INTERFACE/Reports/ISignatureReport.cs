...
namespace Interface.Reports
{
    public interface ISignatureReport
    {
        ...
        JsonResponse GenerateReportExcel(string CompCode, string UserName, string SelectedAction, string IPAddress, string DateFrom = null, string DateTo = null, string HolderFrom = null, string HolderTo = null);
    }
}
