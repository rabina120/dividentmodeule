...
namespace Repository.Esewa.EsewaHelper
{
    public static class EsewaAPIMethods
    {
        ...
        public static JsonResponse AccountValidation(ATTEBatchProcessing aTTEBatchProcessings, string username, string password)
        {
            ...
            try
            {
                ...
                AppLogger.LogData(data, "AccountValidation Request for Batch " + aTTEBatchProcessings.BatchID + " Compcode: " + aTTEBatchProcessings.Compcode);
                ...
                AppLogger.LogData(JsonConvert.SerializeObject(response1.Content), "AccountValidation Rest API Response Content Object for Batch " + aTTEBatchProcessings.BatchID + " Compcode: " + aTTEBatchProcessings.Compcode);
                AppLogger.LogData(JsonConvert.SerializeObject(response1.StatusCode), "AccountValidation Rest API Response Status Code Object for Batch " + aTTEBatchProcessings.BatchID + " Compcode: " + aTTEBatchProcessings.Compcode);
                AppLogger.LogData(JsonConvert.SerializeObject(response1.ResponseStatus), "AccountValidation Rest API Response Status Object for Batch " + aTTEBatchProcessings.BatchID + " Compcode: " + aTTEBatchProcessings.Compcode);
                ...
                if (match.Success)
                {
                    ...
                    else
                    {
                        ...
                        AppLogger.LogData(JsonConvert.SerializeObject(aTTEsewaResponse), "AccountValidation Error  Response for Batch " + aTTEBatchProcessings.BatchID + " Compcode: " + aTTEBatchProcessings.Compcode);
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        AppLogger.LogData(JsonConvert.SerializeObject(output), "AccountValidation Response Match Error  for Batch " + aTTEBatchProcessings.BatchID + " Compcode: " + aTTEBatchProcessings.Compcode);
                    }
                }
                ...
                else
                {
                    ...
                    AppLogger.LogData(JsonConvert.SerializeObject(output), "AccountValidation Response Output Error  for Batch " + aTTEBatchProcessings.BatchID + " Compcode: " + aTTEBatchProcessings.Compcode);
                ...
                jsonResponse.ResponseData = aTTEBatchProcessings;
                AppLogger.LogData(JsonConvert.SerializeObject(aTTEsewaResponse), "AccountValidation Response for Batch " + aTTEBatchProcessings.BatchID + " Compcode: " + aTTEBatchProcessings.Compcode);
            ...
            catch (Exception ex)
            {
                ...
                aTTEBatchProcessings.Percentage = "0";
                jsonResponse.ResponseData = aTTEBatchProcessings;
                AppLogger.LogErrorToText(ex, "Account Validation/EsewaApiMethods");
                AppLogger.LogData(JsonConvert.SerializeObject(ex), "AccountValidation Exception Caught on Batch: " + aTTEBatchProcessings.BatchID + " Compcode: " + aTTEBatchProcessings.Compcode);
                return jsonResponse;
        ...
        public static JsonResponse TransactionProcessingBatch(List<ATTEBatchProcessing> aTTEBatchProcessings, string username, string password, string SourceBank, string SourceAccountNum)
        {
            ...
            try
            {
                ...
                {
                    //jsonResponse = _transctionProcessing.SaveErrorRemarks(aTTAccount.token, output, null);
                    AppLogger.LogData(JsonConvert.SerializeObject(output), "EsewaTransaction", DateTime.Now.ToString());
        ...
        public static JsonResponse TransactionProcessing(List<ATTEBatchProcessing> aTTEBatchProcessings, string SourceBank, string SourceAccountNum)
        {
            ...
            foreach (ATTEBatchProcessing aTTEBatchProcessing in aTTEBatchProcessings)
            {
                ...
                string serializedObject = JsonConvert.SerializeObject(aTTAccount);
                AppLogger.LogData(serializedObject, "Transaction Processing Request for Batch " + aTTEBatchProcessing.BatchID + " Compcode: " + aTTEBatchProcessing.Compcode);
                    ...
                    if (response.IsSuccessful)
                    {
                        ...
                        if (!output.error)
                        {
                            ...
                            if (valid)
                            {
                                ...
                                ATTEsewaResponse aTTEsewaResponse = JsonConvert.DeserializeObject<ATTEsewaResponse>(finalOutput);
                                AppLogger.LogData(finalOutput, "Transaction Processing Response for Batch " + aTTEBatchProcessing.BatchID + " Compcode: " + aTTEBatchProcessing.Compcode);
                ...
                catch (Exception ex)
                {
                    ...
                    AppLogger.LogErrorToText(ex, "Transaction Processing Error for Batch " + aTTEBatchProcessing.BatchID + " Compcode: " + aTTEBatchProcessing.Compcode);
                }
                AppLogger.LogData(JsonConvert.SerializeObject(aTTEBatchProcessing), "Transaction Processing for Batch " + aTTEBatchProcessing.BatchID + " Compcode: " + aTTEBatchProcessing.Compcode);
