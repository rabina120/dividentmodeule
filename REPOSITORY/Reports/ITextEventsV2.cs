...
{
    public class ITextEventsV2 : PdfPageEventHelper
    {
        private string CompName, CompCode, ReportType;
        private List<ATTGenericReport> tableHeaders;
        public ITextEventsV2(string CompCode, string CompName, string ReportType, List<ATTGenericReport> tableHeaders, string RootPath)
        {
        ...
        public ITextEventsV2(string v, string compEnName, List<ATTGenericReport> tableHeaders1, string RootPath)
        {
            this.v = v;
        ...
        private List<ATTGenericReport> tableHeaders1;
        ...
        public override void OnEndPage(iTextSharp.text.pdf.PdfWriter writer, iTextSharp.text.Document document)
        {
            ...
            Phrase p1Header = new Phrase(CompName + " | " + ReportType, baseFontBold);
            ...
            PdfPCell pdfCell3 = new PdfPCell(new Phrase("Date:" + PrintTime.ToString("yyyy-MM-dd"), baseFontSmall));
            ...
            if (columnDefinitionSize.Length != 0)
            {
                ...
                foreach (ATTGenericReport tableHeader in tableHeaders)
                {
                    PdfPCell pdfPCell = new PdfPCell(new Phrase(tableHeader.ColumnName, baseFontBold));
                    pdfPCell.Border = 0;
                ...
                Chunk headerChunk = new Chunk(logo, 0, 0, true);
                ...
                // pdfTab.AddCell(new PdfPCell());
                //pdfTab.AddCell(pdfCell4);
                //table.AddCell(lineSeparatorTotal);
                ...
                cb.MoveTo(0, document.PageSize.Height - 60);
