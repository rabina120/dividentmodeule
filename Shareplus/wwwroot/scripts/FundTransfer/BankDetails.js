...
var BankDetails = function () {
    ...
    self.UpdateBanks = function () {
        for (var i = 0; i < $('#BankDetails').DataTable().data().length; i++) {
            ...
            var x = i + 1;
                ...
                $.ajax({
                    type: "post",
                    url: '/FundTransfer/BankDetails/UpdateBanks',
                    datatype: "json",
                    beforeSend: function (xhr) {
                        xhr.setRequestHeader("XSRF-TOKEN",
                            $('input:hidden[name="__RequestVerificationToken"]').val());
    ...
    self.GetBanksFromAPI = function () {
                ...
                $.ajax({
                    ...
                    url: '/FundTransfer/BankDetails/GetBanksFromAPI',
    ...
    self.SetBankCode = function () {
        ...
        $.ajax({
            ...
            url: '/FundTransfer/BankDetails/UpdateBankDetails',
            datatype: "json",
    ...
    self.GetBanks = function () {
        ...
        $('#BankDetails').DataTable().destroy();
            $.ajax({
                type: "post",
                url: '/FundTransfer/BankDetails/GetBanks',
