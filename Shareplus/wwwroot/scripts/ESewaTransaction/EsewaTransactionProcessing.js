...
var AccountValidationViewModal = function () {
    ...
    self.LoadDividendLists = function () {
        ...
        if (companyCode != '') {
            $.ajax({
                type: "post",
                url: '/ESewaTransaction/EsewaTransactionProcessing/GetDividendList',
    ...
    self.CheckStatus = function () {
        if (self.Validation()) {
            ...
            $.ajax({
                type: 'POST',
                url: '/ESewaTransaction/EsewaTransactionProcessing/CheckBatchStatus',
        ...
        if (self.Validation() && self.TransactionProcessingValidation()) {
            if (!Validate.empty(self.CurrentBatch())) {
                ...
                $.ajax({
                    ...
                    url: '/ESewaTransaction/EsewaTransactionProcessing/TransactionProcessing',
    ...
    self.LoadBankList = function () {
        ...
        $.ajax({
            type: "post",
            url: '/EsewaTransaction/EsewaTransactionProcessing/GetSourceBankList',
            datatype: "json",
            data: {'Compcode':self.SelectedCompany()},
            beforeSend: function (xhr) {
                xhr.setRequestHeader("XSRF-TOKEN",
